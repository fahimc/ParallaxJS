var Parallax = {
	...
	checkChildOnScreen : function() {
		...
		if(this.currentIndex!=Number(arr[0]) + 1)this.excuteCallbacks(this.id.parallaxHolder, this.eventNames.onChange, this.currentIndex);
	...
	resize : function() {
		this.setChildren();
		console.log("resize",this.currentIndex);
